...
const hasTaskId = computed(() => ['domain', 'site', 'ip', 'url', 'cip', 'cert', 'service', 'vuln', 'fileleak', 'poc', 'stat_finger', 'npoc_service', 'nuclei_result', 'wih', 'dirsearch_result', 'github_task', 'github_result', 'github_monitor_result'].includes(collection.value))
